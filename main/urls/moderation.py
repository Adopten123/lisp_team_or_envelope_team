...
moderation_patterns = [
    ...
    path(
        ...
        views.moderation_schedule_slot_create,
        name='schedule_slot_create',
    ),
    path(
        'moderation_schedule/exception/new/',
        views.moderation_schedule_exception_create,
    ...
    path(
        'moderation_subject/disciplines/<int:pk>/edit/',
        views.moderation_discipline_edit,
        name='discipline_edit',
    ),
    path(
        'moderation_subject/disciplines/<int:pk>/delete/',
        views.moderation_discipline_delete,
        name='discipline_delete',
    ),

    path('moderation_subject/curriculum/', views.moderation_curriculum_list, name='curriculum_list'),
    path(
        'moderation_subject/curriculum/<int:pk>/edit/',
        views.moderation_curriculum_edit,
        name='curriculum_edit',
    ),
    path(
        'moderation_subject/curriculum/<int:pk>/delete/',
        views.moderation_curriculum_delete,
        name='curriculum_delete',
    ),

    path('moderation_subject/teaching/', views.moderation_teaching_list, name='teaching_list'),
    path(
        'moderation_subject/teaching/<int:pk>/edit/',
        views.moderation_teaching_edit,
        name='teaching_edit',
    ),
    path(
        'moderation_subject/teaching/<int:pk>/delete/',
        views.moderation_teaching_delete,
