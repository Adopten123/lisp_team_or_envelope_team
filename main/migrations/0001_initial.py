...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(choices=[('Moderator_3lvl', 'Модератор 3ур.'), ('Moderator_2lvl', 'Модератор 2ур.'), ('Moderator_1lvl', 'Модератор 1ур.'), ('Teacher', 'Учитель'), ('Journalist', 'Журналист'), ('Headman', 'Модерация группы'), ('Student', 'Студент'), ('Applicant', 'Абитуриент'), ('Guest', 'Гость')], max_length=64)),
        ...
        migrations.AddField(
            ...
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='schedule_slots', to='main.studentgroup', verbose_name='Группы'),
        ),
        migrations.CreateModel(
            name='StudentRole',
            fields=[
        ...
        migrations.AddField(
            model_name='scheduleslot',
            name='teaching',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_slots', to='main.teaching', verbose_name='Курс (Teaching)'),
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
        ...
        migrations.AddField(
            model_name='scheduleslot',
            name='university',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_slots', to='main.university', verbose_name='Университет'),
        ),
        migrations.CreateModel(
            name='NewsPost',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_type', models.CharField(choices=[('USE', 'ЕГЭ'), ('internal', 'Внутренний'), ('other', 'Другое')], default='USE', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='admission_request', to='main.program')),
            ],
            options={
